...
export const Question = ({question, declarations, answer, userId, isAdmin, isPowerPoint}: {
    question: IQuestion,
    ...
    const onSubmit = async () => {
        ...
        await createAnswer({
            answer: {answers: responses, question: question._id.toString("hex"), user: userId},
            path: ""
        });
    }
        ...
        <>
            ...
            {loaded ?
                <>
                    ...
                    <Math text={question.question} responses={responses} savedResponses={savedResponses}
            ...
            {!isPowerPoint && (loaded && isAdmin ?
                ...
                : loaded &&
                <Button variant={"contained"} disabled={submitted || answered}
                        onClick={onSubmit}>{submitted || answered ? "Submitted" : "Submit Answer"}</Button>)
            }
        </>
    );
};
